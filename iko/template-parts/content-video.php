...
$iko_video_url = function_exists('get_field') ? get_field('fromate_style') : NULL;
...
<?php if (is_single()) : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-standard-post blog-details-wrap format-video'); ?>>

        <?php if (has_post_thumbnail()) : ?>
            <div class="blog-standard-thumb position-relative">
                <?php the_post_thumbnail('full', ['class' => 'img-responsive']); ?>
                <?php if (!empty($iko_video_url)) : ?>
                    <a href="<?php print esc_url($iko_video_url); ?>" class="video--icon popup-video"><i class="fas fa-play"></i></a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog-standard-post format-video'); ?>>

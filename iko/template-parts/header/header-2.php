...
// Header Top
$iko_show_header_top = get_theme_mod('iko_show_header_top', false);
$iko_header_welcome = get_theme_mod('iko_header_welcome', __('Sign up and receive 20% bonus discount on checkout.', 'iko'));
$header_margin = $iko_show_header_top ? '' : 'mt-0';
...
<header>
    ...
    <?php if (!empty($iko_show_header_top)) : ?>
        <div class="header-top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-top-content text-center">
                            <p><?php echo esc_html($iko_header_welcome); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="sticky-header" class="menu-area menu-area-two <?php echo esc_attr($header_margin) ?>">
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul class="list-wrap">
                                        ...
                                        <?php if (!empty($iko_show_header_button)) : ?>
                                            <li class="header-btn"><a href="<?php echo esc_url($iko_header_btn_url) ?>" class="btn"><?php echo esc_html($iko_header_btn_text); ?></a></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            <?php endif; ?>

...
if ( !class_exists( 'IKO_Navwalker_Class' ) ) {
    /**
     * WP_Bootstrap_Navwalker class.
     *
     * @extends Walker_Nav_Menu
     */
    class IKO_Navwalker_Class extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
            ...
            if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
                ...
                $atts['class'] = 'dropdown-toggle nav-links';
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'edit_theme_options' ) ) {
                ...
                $fallback_output .= '>';
                $fallback_output .= '<li><a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr__( 'Home', 'iko' ) . '">' . esc_html__( 'Home', 'iko' ) . '</a></li>';
                $fallback_output .= '</ul>';
                if ( $container ) {
                    $fallback_output .= '</' . esc_attr( $container ) . '>';
                }

...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper product-desc-wrap">
		...
		<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
			<div class="tp-content-tab woocommerce-Tabs-panel woocommerce-Tabs-panel--<?php echo esc_attr( $key ); ?> panel entry-content wc-tab" id="tab-<?php echo esc_attr( $key ); ?>" role="tabpanel" aria-labelledby="tab-title-<?php echo esc_attr( $key ); ?>">
				<?php
